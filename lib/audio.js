(function () {
  ...
  AudioEngine.prototype._playLoop = function (trackName, melody, bass, options) {
    ...
    this.sequence = setInterval(function () {
      ...
      if (melody[i]) self._note(melody[i], stepMs / 1000 * options.melodyDur, now, options.melodyGain);
  ...
  AudioEngine.prototype.playMenu = function () {
    this._playLoop('menu',
      ...
      [262, 330, 392, 440, 392, 330, 262, 220,
       294, 370, 440, 494, 440, 370, 294, 220],
      /* bass — C3 G3 A3 G3 */
      [131, 0, 196, 0, 220, 0, 196, 0,
       147, 0, 185, 0, 220, 0, 185, 0],
      { bpm: 112, melodyDur: 0.7, melodyGain: 0.22,
        bassDur: 0.9, bassGain: 0.12,
  ...
  AudioEngine.prototype.playGame = function () {
    this._playLoop('game',
      ...
      [220, 262, 294, 349, 330, 294, 262, 220,
       247, 294, 330, 392, 370, 330, 294, 247],
      /* bass */
      [110, 0, 165, 0, 138, 0, 165, 0,
       123, 0, 185, 0, 138, 0, 185, 0],
      { bpm: 148, melodyDur: 0.6, melodyGain: 0.2,
        bassDur: 0.85, bassGain: 0.1,
        drum: function (engine, now, i) {
