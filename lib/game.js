(function () {
  ...
  Game.prototype.win = function () {
    ...
    if (window.SnakeGame.Scores) {
      window.SnakeGame.Scores.save(this.score, elapsed, 'won');
    }
  ...
  Game.prototype.lose = function () {
    ...
    var elapsed = Math.floor((Date.now() - this.levelStartTime) / 1000);
    if (window.SnakeGame.Scores) {
      window.SnakeGame.Scores.save(this.score, elapsed, 'lost');
    }
  ...
  Game.prototype.endLevel = function (ending) {
    ...
    /* Save the score for won/lost endings */
    try {
